...
def seed_db():
    """Carga datos iniciales de forma segura (solo si no existen)."""
    try:
        ...
        productos = [
            ...
            Product(
                name="Latte Vainilla",
                description="Café suave con esencia de vainilla natural",
                price=2800,
                stock=15,
                category_id=cafes.id,
                is_active=True
            ...
            Product(
                name="Brownie",
                description="Brownie casero de chocolate belga",
                price=2200,
                stock=25,
